...
const StatementPopup = ({setPopupToggle}) => {
  ...
  return (
    ...
    {
      toggle ? <Button onClick={AddStatement}>Submit</Button> :     <Flex gap={2} color="rgb(189,31,43)" alignItems={"center"} onClick={AddStatement}>
     ...
     {toggle &&  <Textarea mt={5} placeholder="Enter your statement" onChange={(e)=>setText(e.target.value)}/>}

      <Box mt={5}>
       { allStatement?.map((e)=>(
         <StatementDisplay key={
e.id
} id={
e.id
} statement={e.statement} allStatement={allStatement} setAllStatement={setAllStatement}/>
